...
--[[
            THIS IS NOT MINE! ITS COPIED SO WHEN THE OLD VERSION WILL GET DELETED OR HACKED THIS IS THE MAIN VERSION!
            IM GOING TO UPDATE THIS WITH EVERY InfiniteYield AND Moon UPDATE!
        Mschub -- Universal Script
        Dex
